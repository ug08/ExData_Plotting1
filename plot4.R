...
plot(powerfeb$Voltage ~ powerfeb$datetime, type ="l", xlab="datetime", ylab="voltagae", ylim = c(234,246))
...
plot(powerfeb$Global_reactive_power ~ powerfeb$datetime, type= "l", ylab="Global_reactive_power", xlab="datetime")